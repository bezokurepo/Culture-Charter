...
Further principles will follow - for example see the section on Universal Guidelines for AI (https://github.com/bezokurepo/Culture-Charter/tree/main/UGAI). As the service evolves we will listen to diverse cultural groups, including groups who eschew modern technology, respecting any requests for voices and text to be excluded from training data.
